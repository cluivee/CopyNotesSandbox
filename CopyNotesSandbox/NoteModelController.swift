...
class NoteModelController: ObservableObject {
    ...
    @Published var dummyArray = [Note(nr: 2, headerCode: "1", headerText: "Section 1", title: "First Title", bodyText: "description"),
                                 Note(nr: 3, headerCode: "2", headerText: "Section 1", title: "Second Title", bodyText: "second description"),
                                 Note(nr: 4, headerCode: "3", headerText: "Section 1", title: "Third Title", bodyText: "third description"),    ]
